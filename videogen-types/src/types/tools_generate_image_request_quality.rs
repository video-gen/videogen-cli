...
pub enum GenerateImageRequestQuality {
    Low,
    Standard,
    High,
...
impl Serialize for GenerateImageRequestQuality {
...
impl<'de> Deserialize<'de> for GenerateImageRequestQuality {
...
impl fmt::Display for GenerateImageRequestQuality {
