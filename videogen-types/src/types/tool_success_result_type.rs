...
pub enum ToolSuccessResultType {
    Image,
    Video,
    Audio,
    Pdf,
...
impl Serialize for ToolSuccessResultType {
...
impl<'de> Deserialize<'de> for ToolSuccessResultType {
...
impl fmt::Display for ToolSuccessResultType {
