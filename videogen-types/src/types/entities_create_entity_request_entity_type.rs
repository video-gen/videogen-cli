...
pub enum CreateEntityRequestEntityType {
    Actor,
    Product,
    VisualStyle,
...
impl Serialize for CreateEntityRequestEntityType {
...
impl<'de> Deserialize<'de> for CreateEntityRequestEntityType {
...
impl fmt::Display for CreateEntityRequestEntityType {
