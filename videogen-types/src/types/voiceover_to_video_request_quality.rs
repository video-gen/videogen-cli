...
pub enum VoiceoverToVideoRequestQuality {
    Low,
    Standard,
    High,
...
impl Serialize for VoiceoverToVideoRequestQuality {
...
impl<'de> Deserialize<'de> for VoiceoverToVideoRequestQuality {
...
impl fmt::Display for VoiceoverToVideoRequestQuality {
